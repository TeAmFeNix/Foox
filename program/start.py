...
async def start_(c: Client, message: Message):
    ...
    await message.reply_text(
        f"""✯ هلا يبعد عيني {message.from_user.mention()} \n
في بوت تشغيل الاغاني المميز الاول في السرعة ✯.

-› MᥲᎥꪀƚᥲᎥꪀᥱძ ხy -› [S᥆ᥙrᥴᥱ Frᥱᥱძ᥆ꪔ](http://t.me/Mus_3b2)
-› ᖇᎥgɦƚ᥉ ხy -› [Dᥱ᥎ᥱᥣ᥆ρᥱr Mᥙꪀƚᥲᤁᥱr](http://t.me/iPiiii)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("✯ الأوامر ✯", callback_data="command_list"),
...
async def alive(c: Client, message: Message):
    ...
    await c.send_photo(
        chat_id,
        photo=f"https://te.legra.ph/file/80b2ff7fe2725a7362fe9.jpg",
        caption=text,

...
async def start_set(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""هلا يبعد عيني [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) ✯\n
...
4✯[Dᥱ᥎ᥱᥣ᥆ρᥱr Mᥙꪀƚᥲᤁᥱr](http://t.me/iPiiii) اذ لم تستطيع اضافة المساعد او واجهت مشاكل تحدث مع رئيس الوزراء السيد .
